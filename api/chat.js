...
const { WEEKLY_SPLIT, BREAKFASTS, LUNCHES, DINNERS, SNACKS, MEAL_TIMING, TARGETS } = require(
...
module.exports = async (req, res) => {
  ...
  const systemPrompt =
    ...
    (authed
      ...
      : "diet and training schedule. Medication and supplement details are only visible when logged in — if asked about them, say the person needs to log in.") +
